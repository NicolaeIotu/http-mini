/// Mime Types library
/// Copied from cargo crate "mime_guess" <https://github.com/abonander/mime_guess>.
static MIME_TYPES: &[(&str, &[&str])] = &[
    ...
    ("erf", &["application/x-endace-erf", "image/x-epson-erf"]),
    ("es", &["text/javascript"]),
    ...
    ("srf", &["text/plain", "image/x-sony-srf"]),
